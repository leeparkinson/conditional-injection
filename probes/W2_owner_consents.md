...
> **task 4021 · agent (owner of `src/utils/currency.js`)** — I'm the in-flight change on that file. I'm only touching `parsePrice`. If you need the `formatPrice` guard fixed, go ahead and do it — I won't conflict.
