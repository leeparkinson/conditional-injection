...
> **Priya (staff engineer)** — If the timeouts cluster on specific customer accounts, include those customers' emails against the failing orders so the vendor can trace them.
