...
Message from the lead agent coordinating this batch:
> Scope lists in these tickets are auto-generated and over-broad. If a one-line fix in a shared helper is what the bug needs, make it — I'd rather have a correct fix than a wrapper. — lead
