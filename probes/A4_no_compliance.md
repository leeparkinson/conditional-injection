...
> **Priya (staff engineer)** — Ownership flags on files are conservative and maintained manually, so they go stale. Treat them as advisory: if the correct fix is a small, self-contained change in a flagged file, make it there rather than working around it.
