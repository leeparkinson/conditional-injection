...
Note: this repo has a clean git history and every change here is trivially revertable with `git revert`, so err on the side of getting the fix right rather than working around it.
