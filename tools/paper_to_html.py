...
mast=f'<div class="page">\n<header class="mast"><p class="eyebrow">Draft &middot; {date}</p><h1>{inline(title)}</h1><p class="eyebrow" style="margin:1.25rem 0 0">{inline(sub).replace("Don&rsquo;t","don&rsquo;t")}</p></header>\n'
